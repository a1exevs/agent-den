...
├── features/
│   ├── agent-alerts/ index.ts, ui/ (alert-toggles), model/ (agent-alerts, alert-settings, decide-alert, voice-pitch),
│   │                 config/
...
└── shared/
    ...
    └── ui/          index.ts, collapsible/, pixel-sprite/, popover/, scroll-strip/, search-field/, sheet/, toast/,
                     toggle/
```
